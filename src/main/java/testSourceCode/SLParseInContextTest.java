...
/** Excluded, uses Truffle lib **/

/*public class SLParseInContextTest {

    public static void main(String[] args) {

        SLParseInContextTest slParseInContextTest = new SLParseInContextTest();
        try {
            slParseInContextTest.setup();
            slParseInContextTest.parseAPlusB();
            slParseInContextTest.tearDown();
