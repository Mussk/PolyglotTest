...
/** Partially excluded, Logger functionality **/
...
public class SLLoggerTest {
    ...
    static {
        ADD_SL = Source.newBuilder("js", "function add(a,b) {return a + b;} function main() {return add(1,1);}", "add.js").buildLiteral();
        MUL_SL = Source.newBuilder("js", "function mul(a,b) {return a * b;} function main() {return mul(1,1);}", "mul.js").buildLiteral();
    }
    ...
    private Context createContext(Map<String, String> options) {
        ...
        currentContext = Context.newBuilder("js").options(options).logHandler(testHandler).build();
    ...
    public void testLoggerNoConfig() {
        ...
        if(functionNames(testHandler.getRecords()).isEmpty()) {

            System.out.println("testLoggerNoConfig: " + true);
    ...
    public void testLoggerSlFunctionLevelFine() {
        final Context context = createContext(createLoggingOptions("js", "com.oracle.truffle.sl.runtime.SLFunction", "FINE"));
        executeSlScript(context);
